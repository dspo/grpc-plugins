...
import (
	...
	"github.com/dspo/grpc-plugins/internal/codegenerator"
	"github.com/dspo/grpc-plugins/internal/descriptor"
	"github.com/dspo/grpc-plugins/protoc-gen-openapi3/internal/genopenapi"
...
var (
	...
	outputFormat                   = flag.String("output_format", string(genopenapi.FormatYml), fmt.Sprintf("output content format. Allowed values are: `%s`, `%s`", genopenapi.FormatJSON, genopenapi.FormatYAML))
